...
**This policy applies to any product created and owned by Climate Coach Ltd. That includes Climate Coach (any version), HEY, Highrise, Campfire, Backpack, Writeboard, and Ta-da List. There are [some nuances with HEY](hey/index.md) because its subscriptions are on an annual basis only.*
